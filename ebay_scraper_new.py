...
def get_seller_info_from_span(seller_persona_span):
    print ("Num remarks:", get_in_paranthasis(cleanhtml( str(seller_persona_span.contents[1]) )))
...
def get_data_from_seller_page(seller_span):
    ...
    overall_rating = int( cleanhtml( str(soup.find(class_='overall-rating-summary').
